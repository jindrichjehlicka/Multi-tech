    ...
    <v-flex xs12 md8>
      ...
      <panel title="Create Product">
        <v-form v-model="valid" ref="form" lazy-validation>
          ...
          <v-text-field label="Model" required :rules="[v => !!v || 'Model number or name is required']" v-model="product.model"></v-text-field>

          <v-text-field label="Company Logo URL" required :rules="[v => !!v || 'Item is required']" v-model="product.companyLogo"></v-text-field>

          <v-text-field label="Description" multi-line v-model="product.description"></v-text-field>

          <v-text-field label="Manual URL" required :rules="[v => !!v || 'Item is required']" multi-line v-model="product.url"></v-text-field>
        </v-form>
      </panel>
      ...
      <v-btn dark class="green darken-2" @click="create">Create Product
      </v-btn>
